...
class DataValidation:
        ...
        def read_data(file_path)->pd.DataFrame:
            try:
                logging.info("data validation file reading from ingested completed")
        ...
        def detect_dataset_drift(self,base_df,current_df,threshold=0.05)->bool:
            try: 
                ...
                logging.info(f"Drift report file path = {drift_report_path}")
                #Create directory
        ...
        def initiate_data_validation(self)->DataValidationArtifact:
            try:
                ...
                logging.info("train and test file path reading compleated")
                ...
                logging.info("Check validate number of column")
                ...
                logging.info(f"Checking drifting = {status}")
