...
class ModelTrainer:
    def __init__(self,model_trainer_config:ModelTrainerConfig,data_transformation_artifact:DataTransformationArtifact):
        try:
            ...
            logging.info("initiate model trainer config and data transformation artifact")
    ...
    def train_model(self, X_train: np.ndarray, y_train: np.ndarray, x_test: np.ndarray, y_test: np.ndarray) -> ModelTrainerArtifact:
        ...
        logging.info(f"best model score : {best_model_score} for model is {best_model_name}")
        ...
        logging.info("Starting mlflow for training ")
        ...
        self.track_mlflow(best_model,classification_test_metric,X_train)
        logging.info("Starting mlfow for Testing ")
